...
const ModalCongratulations = memo(
  ({ isModalOpen, modalName, isTeacherPage = false }: Props) => {
    return (
        ...
        <div className={styles.modalCongratulations}>
          ...
          {!isTeacherPage && (
            <Typography mode="subtitle" align="center">
              ¡Enhorabuena ya tienes tu nuevo profesor!
            </Typography>
          )}
          {isTeacherPage && (
            <>
              ...
              <Typography align="center">
                Nos pondremos en contacto contigo para hacértelo llegar.
                Escríbenos a
